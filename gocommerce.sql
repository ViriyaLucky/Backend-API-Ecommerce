...
INSERT INTO `tbl_products` (`id`, `title`, `description`, `price`, `image`, `image_path`, `created_date`, `modified_date`) VALUES
(1, 'Bharat Lifestyle Fabric 3 + 1 + 1 Cream Sofa Set', 'Filling Material: Foam\r\nFrame Material: Solid Wood\r\ndiy- Basic assembly to be done with simple tools by the customer, comes with instructions.\r\nThis sofa set is a clear all-rounder', 10000.00, 'product-img1.jpg', 'assets/img/product-img1.jpg', '2021-01-04 12:19:16', NULL),
(2, 'Hindhustan Lifestyle Fabric 3 + 1 + 1 Cream Sofa Set', 'Filling Material: cotton\r\nFrame Material: Oak Wood\r\ndiy- Basic assembly to be done with simple tools by the customer, comes with instructions.\r\nThis sofa set is a clear all-rounder', 8999.00, 'product-img2.jpg', 'assets/img/product-img2.jpg', '2021-01-04 12:32:11', NULL),
(3, ' Chennai Lifestyle Fabric 3 + 2 + 1 Cream Sofa Set', 'Filling Material: Foam\r\nFrame Material: Solid Wood\r\nDIY - Basic assembly to be done with simple tools by the customer, comes with instructions.\r\nThis sofa set is a clear all-rounder', 11999.00, 'product-img3.jpg', 'assets/img/product-img3.jpg', '2021-01-05 11:33:14', NULL);
